...
object ImdbInfo extends {
  ...
  def oldSite(xpath: XPath, doc: org.w3c.dom.Document): (String, String) = {
    (
      ...
      xpath
        .evaluate(
          "//ul[@class='ipc-inline-list ipc-inline-list--show-dividers sc-d3b78e42-2 etAqcO baseAlt baseAlt']",
          doc,
          XPathConstants.STRING
        )
        .toString
  ...
  def newSite(xpath: XPath, doc: org.w3c.dom.Document): (String, String) = {
    (
      ...
      xpath
        .evaluate(
          "//ul[@class='ipc-inline-list ipc-inline-list--show-dividers sc-cb6a22b2-2 aFhKV baseAlt baseAlt']",
          doc,
          XPathConstants.STRING
        )
        .toString
