...
libraryDependencies ++= Seq(
  "org.edla" %% "tmdb-async-client" % "0.1",
...
homepage := Some(url("http://github.com/newca12/movie-catalog"))
...
pomExtra := (
  ...
  <scm>
    <url>git@github.com:newca12/movie-catalog.git</url>
    <connection>scm:git:git@github.com:newca12/movie-catalog.git</connection>
  </scm>
  <developers>
    <developer>
      <id>newca12</id>
